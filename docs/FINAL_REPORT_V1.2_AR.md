...
**تنبيه أمني:** تم استخدام التوكن `<TOKEN_REDACTED>` للدفع ثم إزالته من remote (`https://github.com/...`). **يُنصح بإبطال التوكن بعد هذا الاستخدام** عبر https://github.com/settings/tokens (Revoke) وإنشاء واحد جديد عند الحاجة.
